...
df = pd.read_csv('Admission_Predict.csv')  # Assuming the CSV file is in the same directory
...
for category in df['University Rank Category'].unique():
    ...
    category_data = df_encoded[df_encoded[column_name] == 1]  # Uncomment and define category_data
